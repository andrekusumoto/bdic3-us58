...
public class ClienteController implements Serializable {
    ...
    @EJB
    private negocio.ClienteFacade ejbFacade;
    ...
    public String create() {
     ...
     public String find() {
        try {                        
            List<Cliente> lista = getFacade().findByName(current.getCliNome());
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ClienteFound"));
     ...
     public String findCpf() {
        try {                        
            List<Cliente> lista = getFacade().findByCpf(current.getCliCpf());
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ClienteFound"));
            items.setWrappedData(lista);
            return prepareFind();
        } catch (Exception e) {
    ...
    public String orderByCpf() {
        try {                                 
            List<Cliente> lista = getFacade().orderCpf();
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ClienteFound"));
            items.setWrappedData(lista);
    ...
    public String orderByNome() {
        try {                                 
            List<Cliente> lista = getFacade().orderNome();
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ClienteFound"));
            items.setWrappedData(lista);
            return prepareListOrder();
        } catch (Exception e) {
    ...
    public static class ClienteControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Cliente) {
                ...
                return getStringKey(o.getCliCpf());
            } else {
